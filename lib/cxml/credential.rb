module CXML
  ...
  # Credential contains an Identity element and optionally a SharedSecret or
  # a CredentialMac element. The Identity element states who the Credential
  # represents, while the optional authentication elements verify
  ...
  #
  # *SharedSecred*
  # The SharedSecret element is used when the Sender has a password that
  # the requester recognizes.
  #
  # *CredentialMac*
  # The CredentialMac element is used for the Message Authentication Code (MAC)
  # authentication method. This authentication method is used in situations
  # where the sender must prove to the receiver that it has been authenticated
  # by shared secret by a trusted third party. For example, a direct PunchOut
  # request can travel directly from a buyer to a supplier without going through
  # a network commerce hub, because it contains a MAC
  # (generated by the network commerce hub) that allows the supplier
  # to authenticate it.
  class Credential
    ...
    def render
      ...
      if shared_secret
        ...
        node.Identity.SharedSecret << shared_secret.to_s
      end
